...
class BeerSpiderSpider(scrapy.Spider):
    name = 'comment_spider_2'
    allowed_domains = ['beeradvocate.com']
    
    start_urls = ['https://www.beeradvocate.com/place/list/?start=4000&&brewery=Y&sort=name']
    for i in range(1,199):
        start_urls.append(f'https://www.beeradvocate.com/place/list/?start={4000+i*20}&&brewery=Y&sort=name')
